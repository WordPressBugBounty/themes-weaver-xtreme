...
if (have_posts()) {
    ...
    */
    ...
    $msg = apply_filters('weaverx_author_archives', esc_attr__('Author Archives: %s', 'weaver-xtreme'));
    ...
    $titlew = '<span class="author-title-label">' . sprintf($msg,
            ...
            '" title="' . esc_attr(get_the_author()) . '" rel="me">' . esc_attr(get_the_author()) . '</a></span>'); ?>
