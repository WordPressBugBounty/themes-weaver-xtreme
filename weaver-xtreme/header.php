...
<noscript><p
        ...
        <?php esc_html_e('JAVASCRIPT IS DISABLED. Please enable JavaScript on your browser to best view this site.', 'weaver-xtreme' /*adm*/); ?></p>
</noscript>
...
if (weaverx_getopt('menus_only_header')) {
    // Generate simpler header area for menus only display
    echo '<div id="header">';
    echo '<div id="header-inside" class="block-inside">';
    do_action('weaverx_nav', 'top');
    do_action('weaverx_nav', 'bottom');                // menus at bottom// menus at top
    ...
    if (apply_filters('weaverx_replace_pb_area', 'header') == 'header') {   // if no page builder replacement
...
// ------------------------------------------------------------------------------------
function weaverx_header_image(): void
{
...
// to here, then want to get an image. Where does it come from?
    ...
    if (weaverx_fi($page_type, 'header-image')) {           // Use FI as header image
        ...
        <img src="<?php echo esc_url(get_header_image()) ?>"
             width="<?php echo esc_attr(get_custom_header()->width); ?>" class="wvrx-header-image"
...
//--
function weaverx_expanded_allowed_tags(): array
{
...
function weaverx_logo_and_title(): string
{
    ...
    ?>
    <h1 id="site-title"
        class="<?php echo esc_attr(weaverx_title_class('site_title', true, $h_class)); ?>"><a
                href="<?php echo esc_url(home_url('/')); ?>" title="<?php echo esc_attr($title); ?>"
                rel="home">
    ...
    if ($hide_search != 'hide' && !weaverx_is_checked_page_opt('_pp_hide_headersearch')) { ?>
        <div id="header-search"
             class="<?php echo esc_attr($hide_search); ?>"><?php get_search_form(); ?></div><?php
    }
    ...
    if ($logo) { ?>
        <div id="site-logo"
             class="site-logo <?php echo esc_attr($hide_logo); ?>"><?php echo do_shortcode($logo); ?></div>
    <?php }
